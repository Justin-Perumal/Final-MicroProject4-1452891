...
public class BattleController : MonoBehaviour
{
    ...
    IEnumerator PlayerLifesteal()
    {
        ...
        PlayerUnit.CurrentHP += 1 + PlayerPrefs.GetFloat("LifestealModifier");
        EnemyUnit.CurrentHP -= 1 + PlayerPrefs.GetFloat("LifestealModifier");
    ...
    IEnumerator EnemyTurn()
    {
        if(EnemyIsPoisoned)
        {
            EnemyUnit.CurrentHP -= Mathf.RoundToInt(EnemyUnit.CurrentHP*(0.1f + PlayerPrefs.GetFloat("PoisonModifier")));
            EnemyHUD.SetHUD(EnemyUnit);
    ...
    IEnumerator BattleWon()
    {
        if(EnemyUnit.UnitName == "Grunt")
        {
            CommandText.GetComponent<TextMeshProUGUI>().text = "You won! Go find another fight!";
            PlayerPrefs.SetFloat("Experience", PlayerPrefs.GetFloat("Experience")+2 + PlayerPrefs.GetFloat("ExperienceModifier"));
            Debug.Log(PlayerPrefs.GetFloat("Experience"));
            ChangeStats();
        ...
        {
            CommandText.GetComponent<TextMeshProUGUI>().text = "You won! The adventure continues!";
            PlayerPrefs.SetFloat("Experience", PlayerPrefs.GetFloat("Experience")+4 + PlayerPrefs.GetFloat("ExperienceModifier"));
            Debug.Log(PlayerPrefs.GetFloat("Experience"));
            ChangeStats();
            yield return new WaitForSeconds (4f);
            SceneManager.LoadScene("BattleSelect");
        ...
        {
            CommandText.GetComponent<TextMeshProUGUI>().text = "You've beaten the Boss! Congratulations!";
            PlayerPrefs.SetFloat("Experience", PlayerPrefs.GetFloat("Experience")+ 20 + PlayerPrefs.GetFloat("ExperienceModifier"));
            Debug.Log(PlayerPrefs.GetFloat("Experience"));
            ChangeStats();
    ...
    void EnemyDmg()
    {
        ...
        if(EnemyIsCrippled)
        {
            if(PlayerIsDefending)
            {
                PlayerUnit.CurrentHP -= Mathf.RoundToInt((EnemyUnit.Damage/(2+PlayerPrefs.GetFloat("DefenceModifier"))-(1+PlayerPrefs.GetFloat("CrippleModifier"))));
            }
            else
            {
                PlayerUnit.CurrentHP -= (EnemyUnit.Damage-(1+PlayerPrefs.GetFloat("CrippleModifier")));
            }
        }
        else if(!EnemyIsCrippled)
        {
             if(PlayerIsDefending)
            {
                PlayerUnit.CurrentHP -= Mathf.RoundToInt((EnemyUnit.Damage)/(2+PlayerPrefs.GetFloat("DefenceModifier")));
                PlayerIsDefending = false;
            }
            else
            {
    ...
    {
        PlayerPrefs.SetFloat("CurrentPlayerHP", PlayerUnit.CurrentHP);
    }
